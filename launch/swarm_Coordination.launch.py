...
def generate_launch_description():
    ...
    P = np.zeros((N, 3))   
    P[0] = np.array([-2, -19, 0.015])
    P[1] = np.array([-2, -20, 0.015])
    P[2] = np.array([-2, -21, 0.015])
    P[3] = np.array([-2, -22, 0.015])

    P[4] = np.array([-1, -19, 0.015])
    P[5] = np.array([-1, -20, 0.015])
    P[6] = np.array([-1, -21, 0.015])
    P[7] = np.array([-1, -22, 0.015])

    P[8] = np.array([0, -19, 0.015])
    P[9] = np.array([0,  -20, 0.015])
    P[10] = np.array([0, -21, 0.015])
    P[11] = np.array([0, -22, 0.015])

    P[12] = np.array([1, -19, 0.015])
    P[13] = np.array([1, -20, 0.015])
    P[14] = np.array([1, -21, 0.015])
    P[15] = np.array([1, -22, 0.015])
