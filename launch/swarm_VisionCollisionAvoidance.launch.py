...
def generate_launch_description():
    ...
    P = np.zeros((N, 3))   
    P[0] = np.array([-5, -8.66, 0.015])
    P[1] = np.array([-8.66, -5, 0.015])
    P[2] = np.array([-10, 0, 0.015])
    P[3] = np.array([-8.66, 5, 0.015])

    P[4] = np.array([-5, 8.66, 0.015])
    P[5] = np.array([0, 10, 0.015])
    P[6] = np.array([5, 8.66, 0.015])
    P[7] = np.array([8.66, 5, 0.015])

    P[8] = np.array([10, 0, 0.015])
    P[9] = np.array([8.66,  -5, 0.015])
    P[10] = np.array([5, -8.66, 0.015])
    P[11] = np.array([0, -10, 0.015])
